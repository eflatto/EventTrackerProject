...
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`) VALUES (2, 'edwin', 'edwin', 1, 'user');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`) VALUES (3, 'joe', 'joe', 1, 'user');
